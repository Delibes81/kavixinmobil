/*
  # Fix RPC functions to properly handle id_interno field

  This migration fixes the admin RPC functions to properly handle the id_interno field
  when creating and updating properties.

  ## Changes
  1. Drop existing functions to avoid conflicts
  2. Recreate functions with proper id_interno handling
...
-- Recreate admin_create_property function with id_interno support
...
-- Recreate admin_update_property function with id_interno support
